...
<?php session_start(); session_destroy(); ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id="templatemo_main">
       ...
       <tr>
           ...
           <input type="text" name="usuario" style="border: none; border-bottom: 1px;border-bottom-style: solid; border-bottom-color: #969494 ;background: none;" /></td>
       </tr>
                <tr>
                    <td style="border-bottom: none";>Contraseña:</td>
                    <td style="border-bottom: none";><input type="Password" name="contra" style="border: none; border-bottom: 1px;border-bottom-style: solid; border-bottom-color: #969494 ;background: none;"/></td>
                </tr>         
            </table><br />
