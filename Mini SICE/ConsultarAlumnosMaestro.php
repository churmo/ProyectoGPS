...
session_start();
    if ($_SESSION["tipo"]!='mestro') {
       ...
       $conexion = new mysqli("localhost","root","","escuela");
        ...
        $result=$conexion->query("Select * from alumnos where Grupo Like '$Grupo' and Grado like '$Grado' order by `Apellido Paterno`");
        $tabla="";
...
<link href="css/ConsultarAlumnosMaestro.css" rel="stylesheet" type="text/css" />
...
<div id="templatemo_header_wrapper">
	...
	<div id="site_title"><h1><a href="#">Carousel Template</a></h1></div>
     <div id="templatemo_menu" class="ddsmoothmenu">
            ...
            <li><a href="Calificaciones-Maestro.php" class="selected">Maestro
            </a></li>
...
<div id="templatemo_main">
    ...
    <h2>Consultar Alumnos</h2>
        ...
        <h4><center><?php echo $_SESSION["Nombre"]; ?></center></h4>
            <p style="margin-left: 30px;"><b>Ciclo Escolar:</b> Febrero 2018 - Diciembre 2018 <br />
                <b>Grado</b>:<?php echo $_SESSION["Grado"] ?> &nbsp <b>Grupo</b>: <?php echo $_SESSION["Grupo"] ?> <br />
        ...
        <div class="half float_r">
            ...
            <div class="vertical-menu">
              ...
              <a href="Calificaciones-Maestro.php" >Registrar calificaciones</a>
